...
@ConditionalOnBean(type = "javax.ws.rs.core.Application")
...
public class ResteasyAutoConfiguration implements ServletContextAware {
    ...
    public ResteasyDeployment resteasyDeployment(
        ...
        if (servletContext != null) {
            ...
            updateServletContextDeployments(configuration, deployment); // TODO: hmm, is this even necessary?
        }
    ...
    private String getApplicationPath() {
        if (StringUtils.hasLength(properties.getApplicationPath())) {
